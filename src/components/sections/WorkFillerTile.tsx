...
function TileFrame({ href, children }: { href: string; children: React.ReactNode }) {
  const className =
    "group relative flex h-full flex-col items-center justify-center gap-2 overflow-hidden rounded-xl p-6 text-center shadow-lg shadow-black/10 transition-[filter] duration-300 hover:brightness-110";
